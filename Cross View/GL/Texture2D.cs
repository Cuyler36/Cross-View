...
namespace SharpGL.Textures
{
    ...
    public class Texture2D
    {
        ...
        public void SetPixels(OpenGL gl, in byte[] pixels, int width, int height, uint format = OpenGL.GL_BGRA)
        {
            Width = (uint)width;
            Height = (uint)height;

            gl.BindTexture(OpenGL.GL_TEXTURE_2D, textureObject);
            gl.TexImage2D(OpenGL.GL_TEXTURE_2D, 0, OpenGL.GL_RGBA, (int) Width, (int) Height, 0, format,
